#!/usr/bin/env python3
"""
Generoi landing page jokaiselle Suomen kunnalle tuhkaus.fi -sivustolle.
...
def html_page(city, slug, lat, lng, krema_name, road_km, surcharge, nearby):
    ...
    production_url = f"https://tuhkaus.fi/suoratuhkaus-{slug}/"
...
<title>Suoratuhkaus {city} | Läpinäkyvä hinnoittelu – Tuhkaus.fi</title>
...
<header class="nav">
  <div class="nav-in">
    <a href="/suoratuhkaus/" class="logo">
      <div>
        <span class="logo-main">Tuhkaus</span>
...
<footer class="ftr">
  <div class="ftr-in">
    <div class="ftr-top">
      <div>
        <div class="ftr-brand">Tuhkaus</div>
      ...
      <div class="ftr-col">
        ...
        <a href="mailto:info@tuhkaus.fi">info@tuhkaus.fi</a>
...
for i, city in enumerate(cities_sorted, 1):
    ...
    prod_url  = f"https://tuhkaus.fi/suoratuhkaus-{slug}/"
...
print("\nLuodaan Google Drive -kansio 'Tuhkaus.fi'...")
folder_meta = {
    'name': 'Tuhkaus.fi',
...
print("\nLuodaan Google Sheet 'Tuhkaus.fi — Kaupunkisivut'...")
ss = sheets.spreadsheets().create(body={
    'properties': {'title': 'Tuhkaus.fi — Kaupunkisivut'},
