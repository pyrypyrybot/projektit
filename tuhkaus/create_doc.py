#!/usr/bin/env python3
"""
Luo Tuhkaus.fi toimintaohje Google Docsiin ja jaa epahonkanen@gmail.com
"""
...
# --- Luo dokumentti ---
doc = docs.documents().create(body={'title': 'Tuhkaus.fi — Toimintaohje v1.0'}).execute()
...
sections.append(txt('  A) Turvasähköpostilla: secure@tuhkaus.fi (Zecure/Trustm8-palvelu)', indent=20))
...
sections.append(txt('• Tekninen ylläpito: info@tuhkaus.fi'))
sections.append(txt(''))

# OTSIKKO
sections.append(txt('Tuhkaus.fi — Toimintaohje palveluita hoitavalle taholle', style='HEADING_1'))
