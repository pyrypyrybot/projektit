...
print(f"{TUNNEL}/suoratuhkaus/kaupungit/suoratuhkaus-helsinki.html")
print(f"\nEsimerkkilinkki (Rovaniemi):")
print(f"{TUNNEL}/suoratuhkaus/kaupungit/suoratuhkaus-rovaniemi.html")
print(f"\nEsimerkkilinkki (Utsjoki):")
print(f"{TUNNEL}/suoratuhkaus/kaupungit/suoratuhkaus-utsjoki.html")
